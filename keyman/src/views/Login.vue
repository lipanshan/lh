      ...
      <div class="window">
        ...
        <div v-show="tag === 'one'" class="one">
          ...
          <div class="vcode-wrap">
            ...
            <div @click="sendMsg" class="get-vcode">
              获取验证码
                ...
                <div class="top img-box-wrap">
                  <div class="right">
                    <el-upload action="#" :before-upload="onBeforeUploadheadimgurl2">
                      <div class="img res-hr-logo">
                        <img :src="headimgurl2" alt />
                      </div>
                      <div class="upload-btns hr-logo-btn">*上传公司logo</div>
                      <p class="tips">200K以内</p>
                    </el-upload>
                  </div>
                  <div class="right">
                    <el-upload action="#" :before-upload="onBeforeUploadheadimgurl3">
                      <div class="img res-hr-yyzz">
                        <img :src="headimgurl3" alt />
                      </div>
                      <div class="upload-btns hr-yyzz-btn">*上传营业执照</div>
                      <p class="tips hr-yzz-tips">500K以内</p>
                    </el-upload>
                  </div>
                </div>
                  ...
                  <div class="wrap">
                    ...
                    <div class="upload-wrap">
                      <el-upload action="#" :before-upload="onBeforeUploadheadimgurl4">
                        <div class="upload-img-wrap res-hr-ggzz">
              ...
              <div class="body">
                ...
                <div class="box">
                  <el-form-item prop="money">
                    <el-input
                      v-model.number="resigerJobSee.money"
                      maxlength="9"
                      placeholder="*税前月薪"
                    ></el-input>
                  </el-form-item>
...
const TEL_MESSAGE_TIME = 60 // 短信验证码60秒时间
export default {
  name: 'Login',
  data() {
    return {
      workProofUrl: `${location.protocol}//${location.hostname}/word/关键人才在职证明.docx`,
      phone: '',
      code: '',
      count: -1,
  ...
  methods: {
    ...
    sendMsg() {
      ...
      if (this.sendMsgFlag && this.count <= 0) {
        sendTelVcode({
          ...
          .then(res => {
            ...
            if (res.code === 200) {
              ...
              countNum(TEL_MESSAGE_TIME) // 发送验证码后倒计时60s
            } else {
          ...
          .right {
            ...
            .img {
              ...
              &.res-hr-logo {
                ...
                width: 134px;
                height: 134px;
                background: url(../assets/img/res_hr_logo.png) no-repeat 0 0;
              ...
              &.res-hr-yyzz {
                ...
                & > img {
                  width: 134px;
                  height: 134px;
                  background: url(../assets/img/res_hr_yyzz.png) no-repeat 0 0;
                  background-size: 134px 134px;
                }
              }
              & > img {
